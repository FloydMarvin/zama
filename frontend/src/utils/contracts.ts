...
// Standard FHE Counter ABI - matches fhevm-react-template
...
// Contract addresses - use dynamic address resolution from FHECounterAddresses
// This ensures consistency with deployment artifacts
export const CONTRACT_ADDRESSES = {
  Counter: "0xB7bbcD7C5F2110056F6D0Ff98C76a68b94f1C090", // Sepolia deployment
  EncryptedVoting: "0x48FBCF9e1d6F36D692D93cf8b760de3D99dF5CF0", // Sepolia deployment
  FHEVMFeatureDemo: "0xCDD1B253dA4aD4C6af9Ec98cFCd924F8A4c25073", // Sepolia deployment
};
...
export const FHEVM_ADDRESSES = {
  ...
  DECRYPTION_ADDRESS: "0xb6E160B1ff80D67Bfe90A85eE06Ce0A2613607D1", // Updated to official Sepolia DECRYPTION_ADDRESS
 ...
 *
 * The ABI and address book are generated from deployment artifacts.
 * This function performs a simple lookup in the generated map.
 *
 * Behavior:
 ...
 */
export function getFHECounterByChainId(
  chainId: number | undefined
): FHECounterInfoType {
  if (!chainId) {
    return { abi: FHECounterABI };
  }
  ...
  if (!entry || !("address" in entry) || entry.address === ethers.ZeroAddress) {
    return { abi: FHECounterABI, chainId };
  }

  // Validate address format and deployment
